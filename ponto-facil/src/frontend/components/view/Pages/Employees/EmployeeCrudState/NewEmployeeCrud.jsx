...
export default class NewEmployeeCrud extends React.Component {
                        ...
                        <div className="input-group row">
                            <div className="input col-md-6 col-12 mt-3">
                                    ...
                                    <input type="date"
                                        ...
                                        value={this.props.newUser.data_nascimento}
                                        onChange={e => this.props.invoker.publicUpdateField(e)}
            ...
            <div className="row">
                <div className="col-12 d-flex justify-content-end">
                    <button className="btn btn-primary"
                        onClick={e => this.props.invoker.publicValidateNewUser(e)}>
                        Salvar
                    </button>
